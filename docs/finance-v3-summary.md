# 🎉 Cafe Finance Lite v3 - MVP Завершён
...
- ✅ `/finance/expense-docs` - документы расходов
...
- `docs/accaunting.md` - подробное ТЗ
