# Чек-лист реализации Cafe Finance Lite v3
...
- [ ] **Создать справочник каналов продаж (Channel)**
  - Поля: id, name
...
- [ ] **Создать справочник способов оплаты (TenderType)**
  - Поля: id, name
...
- [ ] **Создать модель CashTx (реальные движения денег)**
  - Поля:
...
- [ ] **Автогенерация CashTx**
  ...
  - Триггеры или сервисные функции
...
- [ ] **Доработать P&L с правильной структурой**
